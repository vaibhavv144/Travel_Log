...
function Register() {
    ...
    return (
        <>
            ...
            <div className="absolute bg-[url('https://img.freepik.com/free-photo/office-supplies_23-2148103974.jpg?size=626&ext=jpg&ga=GA1.1.1413502914.1719878400&semt=ais_user')] bg-no-repeat bg-cover w-full h-full">
                <Header />
